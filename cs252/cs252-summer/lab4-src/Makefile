...
all: thr1 thr2 count count_spin deadlock bounded-buffer 
...
bounded-buffer: bounded-buffer.cc
	g++  -o bounded-buffer bounded-buffer.cc -lpthread

clean:
	rm -f *.o thr1 thr2 count count_spin deadlock bounded-buffer
