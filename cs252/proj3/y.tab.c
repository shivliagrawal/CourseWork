...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    APPEND_STDOUT_STDERR = 267,    /* APPEND_STDOUT_STDERR  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_single_command_list = 18,       /* single_command_list  */
  YYSYMBOL_single_command = 19,            /* single_command  */
  YYSYMBOL_argument_list = 20,             /* argument_list  */
  YYSYMBOL_argument = 21,                  /* argument  */
  YYSYMBOL_executable = 22,                /* executable  */
  YYSYMBOL_io_modifier_list = 23,          /* io_modifier_list  */
  YYSYMBOL_io_modifier = 24,               /* io_modifier  */
...
{
       0,    44,    44,    48,    49,    53,    57,    61,    62,    66,
      73,    74,    78,    89,   102,   103,   107,   116,   125,   134,
     151,   161,   183,   186
};
#endif
...
static const char *const yytname[] =
{
  ...
  "APPEND_STDOUT", "APPEND_STDOUT_STDERR", "BACKGROUND", "$accept", "goal",
  "entire_command_list", "entire_command", "single_command_list",
  "single_command", "argument_list", "argument", "executable",
  "io_modifier_list", "io_modifier", "background", YY_NULLPTR
};
...
{
       0,    13,     6,     0,     2,     4,    15,     8,    11,     1,
       3,     0,    23,     9,     7,     0,     0,     0,     0,     0,
       0,    22,    14,     0,    12,    10,    16,    17,    18,    19,
      20,    21,     5
};
...
{
       0,     3,     6,    15,    16,    17,    18,    19,    22,     0,
      17,     4,    23,    20,    19,     7,     8,     9,    10,    11,
      12,    13,    24,    25,     3,    21,     3,     3,     3,     3,
       3,     3,     6
};
...
#line 78 "shell.y"
          {
       if (strcmp(g_current_single_command->arguments[0], "echo") == 0 && strchr((yyvsp[0].string), '?')) {
         insert_argument(g_current_single_command, strdup((yyvsp[0].string)));
       }
       else {
         check_wild_cards(strdup((yyvsp[0].string)));
       }
     }
#line 1228 "y.tab.c"
    break;
...
#line 89 "shell.y"
       ...
       insert_argument(g_current_single_command, strdup((yyvsp[0].string)));
       g_current_single_command->executable = strdup((yyvsp[0].string));
     }
#line 1243 "y.tab.c"
    break;
...
#line 1257 "y.tab.c"
  ...
  case 17: /* io_modifier: STDIN WORD  */
#line 116 "shell.y"
                {
       if ((g_current_command->in_file) == NULL) {
         g_current_command->in_file = strdup((yyvsp[0].string));
       }
       else {
         fprintf(stderr, "Ambiguous output redirect.\n");
         exit(1);
...
#line 1271 "y.tab.c"
  ...
  case 18: /* io_modifier: STDERR WORD  */
#line 125 "shell.y"
                 {
...
#line 1285 "y.tab.c"
  ...
  case 19: /* io_modifier: STDOUT_STDERR WORD  */
#line 134 "shell.y"
                        {
       if((g_current_command->out_file) == NULL) {
         g_current_command->out_file = strdup((yyvsp[0].string));
...
#line 1307 "y.tab.c"
  ...
  case 20: /* io_modifier: APPEND_STDOUT WORD  */
#line 151 "shell.y"
                        {
       if(g_current_command->out_file == NULL) {
         g_current_command->out_file = strdup((yyvsp[0].string));
...
#line 1322 "y.tab.c"
  ...
  case 21: /* io_modifier: APPEND_STDOUT_STDERR WORD  */
#line 161 "shell.y"
                               {
       if((g_current_command->out_file) == NULL) {
         g_current_command->out_file = strdup((yyvsp[0].string));
