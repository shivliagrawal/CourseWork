...
extern pid32 getppid(pid32 pid);


int addfour(int, int, int, int);

int addfourC(int,int,int,int);
int testaddfourC(void);


pid32 creates(void *funcaddr, uint32 nargs, ...);
