...
extern  void trap6(void);
extern int invalopcode;
...
extern pid32 getppidtrap(pid32 pid);
extern void syscalldisp(void);
extern pid32 getpidtrap(void);
extern pri16 chpriotrap(pid32 pid, pri16 newprio);


extern syscall suspendtrap(pid32 pid);
